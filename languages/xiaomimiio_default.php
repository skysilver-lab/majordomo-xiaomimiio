...
'XIMI_APP_ADVANCED_SETUP' => 'Advanced settings',
...
'XIMI_APP_SOCKET_TIMEOUT' => 'Socket timeout read ',
'XIMI_APP_SOCKET_TIMEOUT_TOOLTIP' => 'The time (in seconds) to wait for a response from the device to the command sent to it. The minimum value is 1 second, the maximum is 10 seconds, the default value is 2 seconds. Change only when absolutely necessary and with the understanding of the possible consequences!',
