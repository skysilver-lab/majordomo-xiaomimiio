...
'XIMI_APP_PERIOD_TOOLTIP' => 'Период (в секундах) поиска устройств в сети с помощью широковещательного запроса. Механизм предназначен для поиска новых устройств, определения доступности (онлайн/оффлайн) текущих и обновления их IP-адресов. Укажите 0, чтобы выключить данный механизм. Не следует ставить значения меньше 15 сек.',
'XIMI_APP_SOCKET_TIMEOUT' => 'Таймаут чтения из сокета ',
'XIMI_APP_SOCKET_TIMEOUT_TOOLTIP' => 'Время (в секундах) ожидания ответа от устройства на отправленную ему команду. Минимальное значение - 1 сек., максимальное - 10 сек, значение по умолчанию - 2 сек. Менять только при крайней необходимости и с пониманием возможных последствий!',
