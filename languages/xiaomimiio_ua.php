...
'XIMI_APP_SOCKET_TIMEOUT' => 'Таймаут читання з сокета ',
'XIMI_APP_SOCKET_TIMEOUT_TOOLTIP' => 'Час (в секундах) очікування відповіді від пристрою на відправлену йому команду. Мінімальне значення - 1 сек., Максимальна - 10 сек, значення за замовчуванням - 2 сек. Міняти тільки при гострій потребі і з розумінням можливих наслідків!',
